...
#%%
def CPAB_transformer(points, theta, params, return_velocities=False):
    if points.is_cuda and theta.is_cuda:
        if not params.use_slow and _gpu_succes:
            ...
            return CPAB_transformer_slow(points, theta, params, return_velocities)
    else:
...
#%%
def CPAB_transformer_slow(points, theta, params, return_velocities=False):
    # Problem parameters
